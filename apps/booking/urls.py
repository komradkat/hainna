...
urlpatterns = [
    path('select-terminal/', views.select_terminal, name='select_terminal'),
    path('set-terminal/<int:terminal_id>/', views.set_terminal, name='set_terminal'),
    ...
    path('board/<str:terminal_name>/', views.PublicBoardView.as_view(), name='public_board'),
    path('board/<str:terminal_name>/feed/', views.public_board_feed, name='public_board_feed'),
]
